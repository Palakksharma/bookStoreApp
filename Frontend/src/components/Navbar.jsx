...
//       </>)
//   return (<>
//     <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed tp-0 left-0 right-0 ${
...
//         <path
//         fillRule="evenodd"
//         d="M9.965 11.026a5 5 0 1 1 1.06-1.0612.755 2.754a.75.75 0 1 1-1.06 1.061-2.755-2.754zm10.5 7a3.5"
//         clipRule="evenodd"
//         />
//     </svg>
//     </label>
    ...
    <>
      <div
        className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 ${
          sticky
            ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-00 dark:text-white duration-300 transition-all ease-in-out"
            : ""
        }`}
      >
        <div className="navbar ">
